...
for j in range(0, numero_matriz):
    ...
    counter_3 = 1
    while(counter_3<numero_matriz):
        #if(numero_matriz <=3):
        if(j==0):
            for k in range(1, numero_matriz):
                #print("esto se convertirá en cero ",matriz_1[j][k])
                matriz_1[j][k] = 0
                #print("j y counter_3",j,counter_3)
                #print("asi queda la matriz::::: ", matriz_1)
        ...
        if(j>=1):
            ...
            if(j==1):
                #print(j, counter_3)
                #print("esto se convertirá en cero ",matriz_1[j][counter_3])
                matriz_1[j][counter_3] = 0
            else:
                #print(j, counter_3)
                #print("esto se convertirá en cero ",matriz_1[j][counter_3])
                for m in range(0, numero_matriz-2):
                    matriz_1[j][j+1] = 0
                    matriz_1[j][j] = elemento_mayor
                #counter_4 =0
